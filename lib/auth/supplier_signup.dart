import 'package:chawla_trial_udemy/auth/supplier_login.dart';
...
class SupplierRegister extends StatefulWidget {
  ...
  static String screenName = '/supplier_register';
  @override
    ...
    if (_imageFile != null) {
      ...
      if (_formKey.currentState!.validate()) {
        ...
        try {
          ...
          //1. Will upload supplier's image in firebase_storage under the
          // name of his/her email id. for that, first we would
          // create the reference (where we need to store those images.)
          firebase_storage.Reference storeRef = firebase_storage
              .FirebaseStorage.instance
              .ref('supplier-images/$_email.jpg');

          // after creating that reference, we uploaded our selected
          ...
          _storeLogo = await storeRef.getDownloadURL();
          ...
          Navigator.pushReplacementNamed(context, SupplierLogin.screenName);
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const AuthHeaderLabel(label: 'Suppliers\' Sign Up'),
